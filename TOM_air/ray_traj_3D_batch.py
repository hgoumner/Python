...
# Load file
#tkinter.Tk().withdraw()
inp = "R:/166_320/Transfer/Goumnerov/TOM_air/Ray_trajectory/1_K/FH0/Normal/T15_100100100/T15_100100100.csv" #ask()
fn = inp[:-4]
...
def N3D(r):
    ...
    if len(r) > 3:
        ...
        return 1+(beta*Ts)/t3d[idy,idx,idz]                             # Output parameters
